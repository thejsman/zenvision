<template>
    <div class="row">
        <div class="m-4 d-flex flex-column">
            ...
            <b-form
                class="p-0"
                @submit.prevent="connectToShopifyStore"
                method="POST"
            >
                <slot />
                ...
                <div
                    class="d-flex mt-4 justify-content-between align-items-center p-0"
                >
                    <div>
                        <a
                            class="font-size-10"
        ...
        onBlur: function(element) {
            ...
            if (store_url !== "") {
                ...
                if (store_url.indexOf(".com") != -1) {
                    store_url = store_url.substring(
                        0,
                        store_url.indexOf(".com") + 4
                    );
                }
            ...
            if (store_url !== "" && !this.CheckURL(store_url)) {
                ...
                try {
                    ...
                    if (count) {
                        ...
                        window.location = `https://${this.store_url}/${process.env.MIX_SHOPIFY_AUTH_URL}&state=${this.calledFrom}-${randomNumber}`;
                    }
                } catch (error) {
                    console.log(error);
                    this.showAlert(

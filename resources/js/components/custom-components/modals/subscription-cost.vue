                ...
                >
                    <template v-slot:cell(action)="row">
                        ...
                        >
                            ...
                            <b-dropdown-item
                                href="#"
                                @click="endSubscription(row)"
                                ><i
                                    class="fas fa-stop-circle text-warning mr-1"
                                />
                                End Subscription
                            </b-dropdown-item>
                            <b-dropdown-item
...
export default {
    ...
    methods: {
        ...
        async deleteSubscription(row) {
            try {
                await axios.delete(`subscriptioncost/${row.item.id}`);
                await this.getSubscriptionCostData();
        ...
        async endSubscription(row) {
            try {
                await axios.patch(`endSubscriptioncost/${row.item.id}`);
                await this.getSubscriptionCostData();
                eventBus.$emit("updateSubscription");
                await this.updateSubscription();
            } catch (err) {
